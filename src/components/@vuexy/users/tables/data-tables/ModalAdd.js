                            ...
                            <Form className="w-100" onSubmit={submitForm}>
                                ...
                                <Card>
                                    ...
                                    <FormGroup className="my-3">
                                        ...
                                        <CustomInput type="select" name="select" id="city" onChange={e => { setPost({ ...post, role: e.target.value }) }} >
                                        ...
                                        <FormGroup className="my-3">
                                            ...
                                            <CustomInput type="select" name="select" id="city" onChange={e => { setPost({ ...post, status: e.target.value }) }} >
                                                <option value="-1"></option>
