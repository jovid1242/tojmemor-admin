...
const Career = lazy(() =>
  import("./views/pages/Career")
)
const Slider = lazy(() =>
  import("./views/pages/Slider")
)
const Stock = lazy(() =>
  import("./views/pages/Stock")
)
const Login = lazy(() =>
  import("./views/pages/authentication/login/Login")
)
const Layouts = lazy(() =>
  import("./views/pages/Layouts")
)
const error404 = lazy(() =>
      ...
      <Router history={history}>
        ...
        />
          ...
          <AppRoute
            ...
            fullLayout
          />
          <AppRoute path="/pages/404" component={error404} fullLayout />
